...
if ($nb_trajet[0] == '0') {
    echo "<br><br><div class='alert alert-danger'>Vous n'êtes actuellement inscrit pour aucun trajet, rendez-vous dans la section \"Rechercher un trajet\"</div>";
} else {
    ...
    while ($donnee = $reponse->fetch()) {
        ...
        if ($nombre == 0) {
            ...
            echo "<button type='submit' name='destinataire' class='btn btn-info' value='" . $donnee["login"] . "'>Envoyer message au conducteur</button></form></td>";
