...
function action() {
    ...
    $sql = 'INSERT INTO trajet (lieu_depart,destination,places_max,places_prises,date,pilote_user_id,heure_dep,prix,effectue) VALUES(:lieu_depart,:ville_arrivee,:places_max,0,:date,:user_id,:heure_dep,:prix,FALSE)';
    $stmt = $bdd->prepare($sql);
    $stmt->bindParam(':lieu_depart', $_POST['ville_depart']);
    $stmt->bindParam(':ville_arrivee', $_POST['ville_arrivee']);
